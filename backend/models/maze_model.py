...
class MazeModel:
    ...
    def skeletonize(self):
        ...
        grayscale = np.array(self.processed_maze_backup.convert("L"))
        binary = grayscale > 0
    ...
    def solve_maze(self):
        ...
        start_on_path = self._find_nearest_path_point(maze_np, (self.start_pos[1], self.start_pos[0]))
        ...
        while not q.empty():
            ...
            for dy, dx in moves:
                ...
                if 0 <= next_y < height and 0 <= next_x < width and img_np[next_y, next_x] == 255 and not visited[next_y, next_x]:
                    ...
                    q.put(((next_y, next_x), path + [(next_y, next_x)]))

        return [], all_visited_nodes

    @staticmethod
    def gradient(start_rgb, end_rgb, t):
